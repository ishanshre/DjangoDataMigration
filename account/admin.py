...
class UserAdmin(BaseUserAdmin):
    ...
    This class extends Django's built-in UserAdmin and adds customizations specific
    to our User model.
    ...
    - add_fieldsets: Defines the layout of fields in the user registration page.

    Note: The User model is registered with the admin panel using the @admin.register
    decorator.
    """
